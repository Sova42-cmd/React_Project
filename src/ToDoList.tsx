    ...
    return (
        <div>
            <div className="to-do-list">
                ...
                {props.tasksToShow.map((element: any) => {
                    return (
                        (<li key={element.id}>
                            ...
                            onClick={ (event)=>{props.pleaseChangeMyStatus(element.id, event.currentTarget.checked)}}

                            />
                            <span>{element.name}</span>
                            <button onClick={() => {
                                props.deleteButtonChild(element.id)
                            }}>X
                            </button>
                        </li>)
                    )
                ...
                <button onClick={() => {
                    props.buttonFilterChild("All")
                }}>All
                </button>
                <button onClick={() => {
                    props.buttonFilterChild("Active")
                }}>Active
                </button>
                <button onClick={() => {
                    props.buttonFilterChild("Completed")
                }}>Completed
                </button>
            </div>
            <div>
